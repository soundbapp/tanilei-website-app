    ...
    <>
      <nav className="fixed left-0 right-0 top-0 z-[200] flex h-[68px] items-center justify-between border-b border-[rgba(201,169,154,0.2)] bg-[rgba(250,246,243,0.93)] px-6 py-0 backdrop-blur-[14px] md:px-12">
        ...
        <ul className="hidden list-none items-center gap-9 md:flex">
          ...
          <li>
            <Link href="#book" className="border border-[var(--rose-gold)] px-5 py-2 text-[0.58rem] uppercase tracking-[0.22em] text-[var(--dark)] no-underline transition-all hover:bg-[var(--rose-gold)] hover:text-white">
              Book Now
            </Link>
          </li>
        </ul>
      ...
      >
        ...
        <Link href="#book" className="mobile-menu-cta mt-8 bg-[var(--dark)] px-12 py-4 text-white no-underline">
          Book My Experience
        </Link>
      </div>
